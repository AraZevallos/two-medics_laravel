...
const activeItemStyles = computed(
    () => (url: string) =>
        isCurrentRoute.value(url)
            ? 'text-neutral-100 hover:text-neutral-100 bg-blue-950 hover:bg-blue-950/90 '
...
<template>
    <div>
        <div
            class="border-sidebar-border/80 flex h-[80px] items-center border-b"
        >
            <div
                class="mx-auto flex h-16 w-full items-center px-4 md:max-w-7xl"
            >
                <!-- Mobile Menu -->
                <div class="lg:hidden">
                    <Sheet>
                        ...
                        >
                            ...
                            >
                                ...
                                <!-- <div
                                    ...
                                    class="absolute bottom-0 left-0 h-0.5 w-full translate-y-px bg-blue-950 dark:bg-white"
                                ></div> -->
                            </NavigationMenuItem>
                        </NavigationMenuList>
                    </NavigationMenu>
